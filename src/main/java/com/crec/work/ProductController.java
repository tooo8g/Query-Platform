...
public class ProductController {
	...
	public void createCode(@RequestParam(required = false) String product_name,
		...
		String result = md.queryCodes(group_id, start, limit);
	...
	public void queryCodes(String group_id, int start, int limit,
			HttpServletResponse response) throws IOException {
		MongoDirver md = new MongoDirver();
	...
	public void deleteByGroupId(@RequestParam(required = false) String group_id,
			HttpServletResponse response) throws IOException {
